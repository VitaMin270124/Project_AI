...
if __name__ == "__main__":
    #ONLY CHANGE 5 LINES
    data_path = './RescueNet' #path to dataset
    nc = 11 #number of class
    path_to_model = "./model_epoch_37.pth" #path to model
    model = Model(model_path=path_to_model) 
    dataset_name = "rescuenet" #must be one of these names: "lars", "rescuenet", "loveda"
